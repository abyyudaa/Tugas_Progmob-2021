package id.aby.progmob_individu;
...
import id.aby.progmob_individu.R;
...
public class UpdateActivity extends AppCompatActivity {
    ...
    private TextView update_angka_semester;
    private Integer id_mahasiswa;
    private String nama_mahasiswa, nim_mahasiswa, jeniskelamin_mahasiswa, prodi_mahasiswa, hobi_mahasiswa, semester_mahasiswa, seekbarValueString;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update_angka_semester = findViewById(R.id.update_angka_semester);
        ...
        semester.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                seekbarValueInt = progress;
                seekbarValueString = Integer.toString(seekbarValueInt);
                update_angka_semester.setText("Semester : " + seekbarValueString);
            }
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Integer semesterTerpilih = semester.getProgress();
